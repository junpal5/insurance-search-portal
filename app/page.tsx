...
export default function Home() {
  ...
  const openDetail = (ins: Insurance) => {
  ...
  const closeDetail = () => {
    ...
    // keep selectedInsurance until next open so back-slide shows content
  };

  return (
    // Fixed viewport container — two panels slide left/right inside it
    <div className="fixed inset-0 overflow-hidden bg-gray-50">
      ...
      >
        {/* ── Panel 1: List ── */}
        <div className="overflow-y-auto bg-gray-50" style={{ width: '50%' }}>
          {/* Header */}
